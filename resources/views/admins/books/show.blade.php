...
<div class="container">
      <div class="row justify-content-center">
            <div class="col-md-6">
                  <div class="card">
                        <div class="card-header">عرض تفاصيل الكتب </div>
                        ...
                        <div class="card-body">
                             ...
                             <form method="POST" action="{{ route('books.destroy', $book) }}" class="d-inline-block">
                                @method('delete')
                                @csrf
                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('هل تود  الحذف')"><i class="fa fa-trash"></i> حذف</button> 
                             </form>
                        </div>
                  </div>
            </div>
