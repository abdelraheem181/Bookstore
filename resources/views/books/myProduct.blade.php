                ...
                @foreach($myBooks as $book)
                    <div class="row p-2 bg-white border rounded">
                        ...
                        <div class="col-md-6 my-auto">
                            <h5><a href="{{ route('book.detials' , $book) }}">{{ $book->title }}</a></h5>
                        ...
                        <div class="align-items-center align-content-center col-md-3 border-left my-auto">
                            ...
                            <div class="d-flex flex-column mt-4"><a href="{{ route('book.detials' , $book) }}" class="btn btn-outline-primary btn-sm" type="button">تفاصيل الكتاب</a></div>
                        </div>
                    </div>
                @endforeach
            @else
