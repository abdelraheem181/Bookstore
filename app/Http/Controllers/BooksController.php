...
class BooksController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admins.books.create' , compact('authors' , 'categories' , 'publishers'));
    }
    ...
    public function edit(Book $book)
    {
        ...
        $categories = Category::all();
        $publishers = Publisher::all();
        return view('admins.books.edit' , compact('book' ,  'authors' , 'categories' , 'publishers'));
    }
    ...
    public function update(Request $request, Book $book)
    {
        ...
        if ($request->has('cover_image')) {
             Storage::disk('public')->delete($request->cover_image );
             $book->cover_image = $this->uploadImage( $request->cover_image );
        }
   ...
   public function detials(Book $book)
   {
    $booksRate  = 0;
    if(Auth::check()) {
        $booksRate = auth()->user()->rayetPurchase()->where('book_id' , $book->id)->first();
    }
    return view('books.detials', compact('book' , 'booksRate'));
   }
